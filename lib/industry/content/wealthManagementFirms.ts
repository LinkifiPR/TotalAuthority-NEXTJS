...
export const wealthManagementFirms: IndustryContent = {
  slug: 'wealth-management-firms',

  meta: {
    title: 'AI Visibility & Authority Building for Wealth Management Firms | TotalAuthority',
    description:
      'See whether ChatGPT, Gemini and Perplexity recommend your firm when prospective clients ask for wealth management. TotalAuthority audits your AI visibility and builds the earned media, content and authority signals that influence those answers.',
    keywords: [
      'AI visibility for wealth management firms',
      'wealth management marketing',
      'wealth manager SEO',
      'wealth management authority building',
      'ChatGPT wealth manager recommendations',
  ...
  cta: {
    ...
    auditSection: 'Audit My Wealth Management Firm',
    auditOffer: 'Get My Wealth Management Firm Audit',
    final: 'Get Your Wealth Management Firm AI Visibility Audit',
    mobile: 'Audit My Wealth Management Firm',
  },
  ...
  hero: {
    ...
    dashboardTitle: 'Wealth Management AI Visibility Audit',
  },
  ...
  dashboard: {
    ...
    competitors: [
      { name: 'Kingsmere Wealth', count: 7 },
      { name: 'Ardent Private Capital', count: 5 },
  ...
  audit: {
    ...
    introPre: 'Our ',
    introPost:
      " tests the commercially valuable questions your clients are likely to ask. We don't simply search for your firm name. We test the service, client-segment and local discovery prompts that could lead to a new appointment.",
    outputCards: [
      {
  ...
  competitorIntel: {
    ...
    identifies: [
      ...
      'Competitors associated with particular client segments',
    ...
    tableRows: [
      { name: 'Kingsmere Wealth', m: 3, p: 7, f: '23×' },
      { name: 'Ardent Private Capital', m: 2, p: 5, f: '14×' },
      { name: 'Belgrave Asset Partners', m: 3, p: 4, f: '11×' },
      { name: 'Thornleigh Private Office', m: 1, p: 3, f: '6×' },
      { name: 'Rowan & Mercer', m: 2, p: 2, f: '5×' },
    ],
    note:
  ...
  brand: {
    ...
    positioning: [
      'Leading firm for discretionary portfolio management',
  ...
  whatWeDo: {
    ...
    pillars: [
      ...
      },
      {
        ...
        body: 'We position your qualified wealth managers as expert sources for journalists covering investments, private client finance, tax and the markets — for editorial features, expert commentary and authoritative backlinks.',
        icon: 'Megaphone',
      },
      {
        num: '04',
  ...
  gaps: {
    heading: 'Why wealth management firms lose AI visibility',
    items: [
      {
      ...
      },
      {
        ...
        b: 'Service pages repeat the same information found on hundreds of other wealth management websites.',
      },
      {
  ...
  auditOffer: {
    heading: 'Get your Wealth Management Firm AI Visibility Audit',
    intro:
