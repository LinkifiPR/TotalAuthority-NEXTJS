...
export const charteredSurveyors: IndustryContent = {
  slug: 'chartered-surveyors',

  meta: {
    title: 'AI Visibility & Authority Building for Chartered Surveyors | TotalAuthority',
    description:
      'See whether ChatGPT, Gemini and Perplexity recommend your firm when prospective clients ask who to hire for a home inspection, appraisal or property condition assessment. TotalAuthority audits your AI visibility and builds the earned media, content and authority signals that influence those answers.',
    keywords: [
      'AI visibility for home inspectors and appraisers',
      'home inspector marketing',
      'property appraiser SEO',
      'inspection authority building',
      'ChatGPT home inspector recommendations',
      'AI search for home inspectors',
      'digital PR for appraisers',
      'ASHI directory rankings',
      'home inspection visibility',
      'AI visibility audit',
    ],
    ogTitle: 'AI Visibility & Authority Building for Chartered Surveyors',
    ogDescription:
      'Find out whether AI platforms recommend your practice or your competitors, and build the authority needed to appear in the answers prospective clients now trust.',
  },

  cta: {
    heroPrimary: 'Get Your AI Visibility Audit',
    auditSection: 'Audit My Practice',
    auditOffer: 'Get My Practice Audit',
    final: 'Get Your Practice AI Visibility Audit',
    mobile: 'Audit My Practice',
  },

  hero: {
    eyebrow: 'AI Visibility and Authority Building for Chartered Surveyors',
    headlinePre: 'Make Your Chartered Surveying Practice the One',
    headlineHighlight: 'AI Recommends',
    headlinePost: '',
    paragraphs: [
      "Your prospective clients are asking ChatGPT, Gemini and Perplexity who to hire for a buyer's home inspection, a full inspection, a property appraisal, a boundary assessment or a commercial property condition assessment.",
    ...
    dashboardTitle: 'Home Inspector & Appraiser AI Visibility Audit',
  },
  ...
  dashboard: {
    ...
    models: [
      { name: 'ChatGPT', score: 40, m: '4/10', c: '5/10' },
    ...
    competitors: [
      { name: 'Wexford Home Inspections', count: 7 },
      { name: 'Castlebridge Inspection Group', count: 5 },
      { name: 'Aldermoor Appraisal Partners', count: 4 },
    ],
    sources: [
      'ASHI',
      'InterNACHI',
  ...
  shift: {
    ...
    intro:
      'People are increasingly using AI platforms to shortlist home inspectors and appraisers, compare services and decide which firms appear credible. They are asking questions such as:',
    questions: [
      'Who is the best home inspector near me?',
      'Which inspector should I use for a full home inspection in Denver?',
      "Where can I find an inspector for a buyer's home inspection?",
      'Which firm has the strongest reviews for boundary assessments?',
      'Who is a trusted appraiser for a commercial appraisal?',
      'Which firm specializes in commercial property condition assessments?',
    ],
    paragraphs: [
      'AI can answer those questions without sending the user through a traditional list of search results. Your practice may have a strong reputation, certified inspectors and appraisers and decades of casework behind it. That does not guarantee you will be included.',
  ...
  audit: {
    ...
    introPre: 'Our ',
    introPost:
      " tests the commercially valuable questions your clients are likely to ask. We don't simply search for your practice name. We test the service, sector and local discovery prompts that could lead to a new instruction.",
    outputCards: [
      {
      ...
      },
      {
        ...
        b: 'A simple view showing the services and searches where your practice is mentioned, not mentioned, recommended or cited.',
      },
    ],
    promptCategories: [
      'Best home inspector in your city',
      'Best inspector for a full home inspection',
      "Best inspector for a buyer's home inspection",
      'Best appraiser for property appraisals',
      'Best firm for boundary and easement assessments',
      'Best firm for commercial property condition assessments',
      'Best inspector for commercial buildings',
      'Best inspector for mold and termite inspections',
      'Best appraiser for expert witness reports',
      'Best firm for boundary disputes',
      'Best firm for natural-language inspection queries',
      'Top-rated home inspectors near me',
    ],
  },
  ...
  competitorIntel: {
    ...
    identifies: [
      ...
      'Practices repeatedly recommended for priority services',
      'Competitors associated with particular inspection types',
    ...
    tableRows: [
      { name: 'Wexford Home Inspections', m: 3, p: 7, f: '23×' },
      { name: 'Castlebridge Inspection Group', m: 2, p: 5, f: '14×' },
      { name: 'Aldermoor Appraisal Partners', m: 3, p: 4, f: '11×' },
      { name: 'Thornbury & Hale', m: 1, p: 3, f: '6×' },
      { name: 'Redgate Building Consultants', m: 2, p: 2, f: '5×' },
    ],
    note:
  ...
  sourceLandscape: {
    ...
    paragraphs: [
      'Improving AI visibility is not only a website project. AI platforms may rely on professional bodies, trade press, review platforms, local recommendation pages, listicles, Reddit discussions, inspector profiles, service comparison pages, competitor websites, social profiles and your own service and location pages.',
    ...
    multiModel: [
      ...
      { name: 'Appraisal Institute', models: ['ChatGPT', 'Perplexity'] },
  ...
  brand: {
    ...
    positioning: [
      'Leading practice for residential home inspections',
      "Trusted firm for buyer's inspections and appraisals",
      'Specialist practice for boundary and easement assessments',
      'Local authority for commercial property condition assessments',
      'Premier advisor on commercial lease and appraisal advisory',
      'Independently recognized expert witness team',
      'Multi-discipline practice with certified inspectors and appraisers',
    ],
    ...
    assess: [
      ...
      'Who your inspectors and appraisers are',
      'Which credentials support your expertise',
      'Which assignments you are best placed to handle',
  ...
  whatWeDo: {
    ...
    pillars: [
      ...
      },
      {
        ...
        body: 'We position your certified inspectors and appraisers as expert sources for journalists covering property, housing, construction, the local market and home buying — for editorial features, expert commentary and authoritative backlinks.',
        icon: 'Megaphone',
      },
      {
        num: '04',
        title: 'Third-Party Authority Development',
        body: 'We strengthen your presence across professional bodies, review platforms, inspector profiles, local business resources, service comparison pages and industry associations.',
        icon: 'Layers',
      },
      {
        num: '05',
        title: 'Brand and Entity Alignment',
        body: 'We align practice names, office locations, inspector and appraiser biographies, credentials, service categories, social profiles, directory listings and website schema so AI systems build a clearer understanding of the practice.',
        icon: 'UserCheck',
      },
      {
        num: '06',
        title: 'Citable Content and Authority Assets',
        body: 'Original research, service guides, inspector-led explainers, market updates, comparison pages, client decision tools and proprietary data — each asset has a defined role in the authority strategy.',
        icon: 'FileText',
      },
      {
        num: '07',
        title: 'Ongoing AI Visibility Tracking',
        body: 'We continue testing the prompts most valuable to your practice: recommendation frequency, brand mentions, service visibility, competitor share of voice, citation sources and positioning accuracy.',
        icon: 'BarChart3',
      },
      {
        num: '08',
        title: 'Local and Multi-Office Authority',
        body: 'For practices operating across one or more offices, we strengthen the local signals AI relies on: office-specific profiles, regional press, community references, structured local data and office-level inspector recognition.',
        icon: 'Building2',
      },
      {
        num: '09',
        title: 'Reputation and Review Authority',
        body: 'We strengthen the consistency and depth of the review platforms and directories AI weighs most heavily for practices — Google, Angi, InterNACHI and ASHI — so sentiment, volume and recency reinforce recommendations.',
        icon: 'Star',
      },
    ],
  },
  ...
  earnedMedia: {
    ...
    paragraphs: [
      ...
      'When an inspector is quoted in a recognized publication, several things happen:',
    ],
    effectsIntro: 'When an inspector is quoted in a recognized publication, several things happen:',
    effects: [
      'The inspector becomes associated with a relevant area of expertise',
    ...
    closing:
      'The same piece of editorial coverage can support brand discovery, SEO, inspector authority, client confidence and AI visibility. This is why earned media forms a central part of the TotalAuthority process.',
    logosHeading: 'Publications featuring our clients and their experts',
  },

  practitioner: {
    sectionLabel: 'Inspector Authority',
    heading: 'Clients trust inspectors, not faceless practice pages',
    paragraphs: [
      'In inspection and appraisal, the person conducting the inspection can be as important as the practice itself. Your senior partners, certified inspectors, building consultants and appraisal specialists hold expertise that can strengthen the authority of the entire brand.',
    ...
    closing:
      'An inspector with genuine expertise can become a recognized source for both clients and journalists. That authority then supports the practice they represent.',
  },
  ...
  services: {
    ...
    intro:
      'Your campaign should not chase vague visibility. It should strengthen the association between your practice, location, inspectors and the services you want to grow.',
    focusHeading: 'An inspection and appraisal strategy may focus on',
    badge: '24 services',
    items: [
      "Buyer's home inspections",
      'Full home inspections',
      'Property appraisals',
      'Boundary and easement assessments',
      ...
      'Commercial appraisal advisory',
      'Commercial lease advisory',
      'Zoning and development advice',
      'Eminent domain',
    ...
    steps: [
      {
        ...
        b: 'We identify the services, locations and client searches most valuable to your practice. This prevents the campaign from becoming a broad exercise with no commercial focus.',
      },
      {
        n: '02',
      ...
      },
      {
        ...
        b: 'We improve the clarity and consistency of brand positioning, inspector entities, service associations, profiles, website information, citations, structured data and local signals.',
      },
      {
        n: '05',
  ...
  beforeAfter: {
    ...
    before: [
      ...
      'Inspectors have little external authority',
    ...
    after: [
      ...
      'Inspector expertise is clearer',
  ...
  whoFor: {
    ...
    intro:
      'TotalAuthority is best suited to established practices that have credible inspectors and appraisers, strong client service and the capacity to convert increased visibility into assignments.',
    typesHeading: 'Best-fit practice types',
    types: [
      'Established residential inspection practices',
      'Regional multi-office firms',
      'Boutique building consultancies',
      'Commercial inspection practices',
      'Boundary and easement specialists',
      'Appraisal-led practices',
      'Expert witness practices',
      'Commercial condition assessment and lease advisory firms',
      'Defect and structural specialists',
      'Historic property assessment practices',
      'Project monitoring specialists',
      'Practices entering new regions',
    ],
    qualification:
      'We build authority around real expertise. The practice must be able to support its positioning through appropriate ASHI, InterNACHI or Appraisal Institute credentials, credible casework and responsible client communication.',
  },

  gaps: {
    heading: 'Why home inspectors and appraisers lose AI visibility',
    items: [
      {
        t: 'Strong reputation, weak external evidence',
        b: 'The practice may have loyal clients but very few independent sources confirming its expertise.',
      },
      {
        t: 'Inspector expertise is hidden',
        b: 'Highly qualified inspectors and appraisers are presented through short team biographies with little external recognition.',
      },
      {
      ...
      },
      {
        ...
        b: 'Service pages repeat the same information found on hundreds of other inspection websites.',
      },
      {
        t: 'Local and brand information conflicts',
        b: 'Practice, inspector and office details are inconsistent across profiles and third-party sources.',
      },
      {
        t: 'Marketing is focused entirely on referrals',
        b: 'The practice wins work through word of mouth but has little searchable, independent authority elsewhere.',
      },
      {
  ...
  auditOffer: {
    heading: 'Get your Practice AI Visibility Audit',
    intro:
      'See how your practice currently appears across ChatGPT, Gemini and Perplexity. Your audit will examine high-intent prompts linked to your location, services and desired positioning.',
  ...
  proof: {
    ...
    cards: [
      ...
      },
      {
        ...
        b: 'Tier-one editorial coverage, dofollow media links, inspector quotes, broadcast opportunities, podcast placements and journalist relationships.',
        icon: 'Megaphone',
      },
      {
      ...
      },
      {
        ...
        b: 'Quotes that reference quality of publications, strategic insight, communication, brand authority, measurable growth and inspector positioning.',
        icon: 'Award',
      },
    ],
  },
  ...
  comparison: {
    heading: 'What makes this different from traditional inspection practice marketing?',
    ...
    authority: [
      ...
      'Build the authority of the practice and its inspectors',
  ...
  faq: {
    intro:
      'Twelve of the questions we hear most often from home inspectors and appraisers considering an AI visibility program.',
    items: [
      {
        q: 'What is AI visibility for a home inspector or appraiser?',
        a: 'AI visibility refers to whether your practice appears when people ask platforms such as ChatGPT, Gemini and Perplexity for recommendations, comparisons or information about inspection and appraisal services in your area. It also includes whether your website is cited, whether your practice is accurately described, and whether your inspectors and appraisers are recognized for relevant expertise.',
      },
      {
      ...
      },
      {
        ...
        a: 'No, but the two are connected. SEO focuses heavily on website rankings and organic traffic. AI visibility also includes third-party mentions, citations, inspector entities, reviews, external profiles, editorial coverage and the sources used to produce generated answers. Strong authority building can support both.',
      },
      {
        q: 'Does our practice still need local SEO?',
        a: 'Yes. Clients still use Google Search and Google Maps, while AI platforms may also rely on local business information. TotalAuthority complements local SEO by developing broader brand, inspector, media and third-party authority.',
      },
      {
        q: 'Why is earned media part of the strategy?',
        a: 'Editorial coverage gives your practice independent recognition. It can connect your inspectors with relevant expertise, create authoritative mentions, earn backlinks and give both clients and AI systems additional sources through which to validate the brand.',
      },
      {
        q: 'Do you work on our website?',
        a: 'Website alignment can form part of the implementation plan. This may include positioning, service associations, inspector information, citable content, entity clarity, structured data and internal site recommendations. The work is directed by the gaps identified in the audit and Blueprint.',
      },
      {
      ...
      {
        q: 'Can you promote individual inspectors and partners?',
        a: 'Yes, provided their experience and credentials support the positioning. Inspector authority can include media commentary, expert biographies, service specialization, professional profiles and expert-led content.',
      },
      {
        q: 'Can you help a multi-office practice?',
        a: 'Yes. Multi-office practices need clear connections between the parent brand, each office, inspectors, service offerings, local profiles and external mentions. The audit and strategy can be structured around individual markets or the wider practice.',
      },
      {
  ...
  finalCta: {
    ...
    footnote:
      'Measured across ChatGPT, Gemini and Perplexity using prompts tailored to your practice, services and location.',
  },
};
