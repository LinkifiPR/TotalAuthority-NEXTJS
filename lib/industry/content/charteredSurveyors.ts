...
export const charteredSurveyors: IndustryContent = {
  ...
  meta: {
    ...
    description:
      'See whether ChatGPT, Gemini and Perplexity recommend your practice when prospective clients ask who to instruct for a survey, valuation or party wall matter. TotalAuthority audits your AI visibility and builds the earned media, content and authority signals that influence those answers.',
    keywords: [
      'AI visibility for chartered surveyors',
      'surveyor marketing',
      'chartered surveyor SEO',
      'surveying authority building',
      'ChatGPT surveyor recommendations',
      'AI search for surveyors',
      'digital PR for surveyors',
      'RICS directory rankings',
      'building survey visibility',
      'AI visibility audit',
    ],
  ...
  hero: {
    ...
    headlinePost: '',
    paragraphs: [
      'Your prospective clients are asking ChatGPT, Gemini and Perplexity who to instruct for a HomeBuyer report, a building survey, a property valuation, a party wall matter or a dilapidations schedule.',
    ...
    dashboardTitle: 'Chartered Surveyor AI Visibility Audit',
  },
  ...
  dashboard: {
    ...
    competitors: [
      { name: 'Wexford Surveying', count: 7 },
      { name: 'Castlebridge Surveyors', count: 5 },
      { name: 'Aldermoor Property Consultants', count: 4 },
    ],
    sources: [
      'RICS',
      'Trustpilot',
  ...
  shift: {
    ...
    intro:
      'People are increasingly using AI platforms to shortlist surveyors, compare services and decide which practices appear credible. They are asking questions such as:',
    questions: [
      'Who is the best chartered surveyor near me?',
      'Which surveyor should I use for a building survey in Leeds?',
      'Where can I find a surveyor for a HomeBuyer report?',
      'Which practice has the strongest reviews for party wall matters?',
      'Who is a trusted surveyor for a commercial valuation?',
      'Which firm specialises in dilapidations and schedules of condition?',
    ],
    paragraphs: [
      'AI can answer those questions without sending the user through a traditional list of search results. Your practice may have a strong reputation, RICS-qualified surveyors and decades of casework behind it. That does not guarantee you will be included.',
  ...
  audit: {
    ...
    promptCategories: [
      'Best chartered surveyor in your city',
      'Best surveyor for a building survey',
      'Best surveyor for a HomeBuyer report',
      'Best surveyor for property valuations',
      'Best surveyor for party wall matters',
      'Best surveyor for dilapidations',
      'Best surveyor for commercial buildings',
      'Best surveyor for damp and timber surveys',
      'Best surveyor for expert witness reports',
      'Best surveyor for boundary disputes',
      'Best practice for natural-language surveying queries',
      'Top-rated chartered surveyors near me',
    ],
  },
  ...
  competitorIntel: {
    ...
    identifies: [
      ...
      'Competitors associated with particular survey types',
    ...
    tableRows: [
      { name: 'Wexford Surveying', m: 3, p: 7, f: '23×' },
      { name: 'Castlebridge Surveyors', m: 2, p: 5, f: '14×' },
      { name: 'Aldermoor Property Consultants', m: 3, p: 4, f: '11×' },
      { name: 'Thornbury & Hale', m: 1, p: 3, f: '6×' },
      { name: 'Redgate Building Consultancy', m: 2, p: 2, f: '5×' },
    ],
    note:
  ...
  sourceLandscape: {
    ...
    topSources: [
      { name: 'RICS', pct: 89 },
      { name: 'Trustpilot', pct: 74 },
      { name: 'Checkatrade', pct: 58 },
    ...
    multiModel: [
      ...
      { name: 'Property Week', models: ['ChatGPT', 'Perplexity'] },
  ...
  brand: {
    ...
    positioning: [
      'Leading practice for residential building surveys',
      'Trusted firm for HomeBuyer reports and valuations',
      'Specialist practice for party wall and boundary matters',
      'Local authority for commercial building surveys',
      'Premier adviser on dilapidations and lease advisory',
      'Independently recognised expert witness team',
      'Multi-discipline practice with RICS-qualified surveyors',
    ],
    ...
    assess: [
      ...
      'Who your surveyors are',
      'Which credentials support your expertise',
      'Which instructions you are best placed to handle',
  ...
  whatWeDo: {
    ...
    pillars: [
      ...
      },
      {
        ...
        body: 'We position your qualified surveyors as expert sources for journalists covering property, housing, construction, the local market and home buying — for editorial features, expert commentary and authoritative backlinks.',
        icon: 'Megaphone',
      },
      {
        num: '04',
        title: 'Third-Party Authority Development',
        body: 'We strengthen your presence across professional bodies, review platforms, surveyor profiles, local business resources, service comparison pages and industry associations.',
        icon: 'Layers',
      },
      {
        num: '05',
        title: 'Brand and Entity Alignment',
        body: 'We align practice names, office locations, surveyor biographies, credentials, service categories, social profiles, directory listings and website schema so AI systems build a clearer understanding of the practice.',
        icon: 'UserCheck',
      },
      {
        num: '06',
        title: 'Citable Content and Authority Assets',
        body: 'Original research, service guides, surveyor-led explainers, market updates, comparison pages, client decision tools and proprietary data — each asset has a defined role in the authority strategy.',
        icon: 'FileText',
      },
      {
        num: '07',
      ...
      },
      {
        ...
        body: 'For practices operating across one or more offices, we strengthen the local signals AI relies on: office-specific profiles, regional press, community references, structured local data and office-level surveyor recognition.',
        icon: 'Building2',
      },
      {
        num: '09',
        title: 'Reputation and Review Authority',
        body: 'We strengthen the consistency and depth of the review platforms and directories AI weighs most heavily for practices — Google, Trustpilot, Checkatrade and RICS — so sentiment, volume and recency reinforce recommendations.',
        icon: 'Star',
      },
    ],
  },
  ...
  earnedMedia: {
    ...
    paragraphs: [
      ...
      'When a surveyor is quoted in a recognised publication, several things happen:',
    ],
    effectsIntro: 'When a surveyor is quoted in a recognised publication, several things happen:',
    effects: [
      'The surveyor becomes associated with a relevant area of expertise',
    ...
    closing:
      'The same piece of editorial coverage can support brand discovery, SEO, surveyor authority, client confidence and AI visibility. This is why earned media forms a central part of the TotalAuthority process.',
    logosHeading: 'Publications featuring our clients and their experts',
  },

  practitioner: {
    sectionLabel: 'Surveyor Authority',
    heading: 'Clients trust surveyors, not faceless practice pages',
    paragraphs: [
      'In surveying, the person conducting the inspection can be as important as the practice itself. Your senior partners, RICS-qualified surveyors, building consultants and valuation specialists hold expertise that can strengthen the authority of the entire brand.',
    ...
    closing:
      'A surveyor with genuine expertise can become a recognised source for both clients and journalists. That authority then supports the practice they represent.',
  },
  ...
  services: {
    ...
    intro:
      'Your campaign should not chase vague visibility. It should strengthen the association between your practice, location, surveyors and the services you want to grow.',
    focusHeading: 'A surveying strategy may focus on',
    badge: '24 services',
    items: [
  ...
  process: {
    ...
    steps: [
      ...
      },
      {
        ...
        b: 'We improve the clarity and consistency of brand positioning, surveyor entities, service associations, profiles, website information, citations, structured data and local signals.',
      },
      {
        n: '05',
  ...
  beforeAfter: {
    ...
    before: [
      ...
      'Surveyors have little external authority',
  ...
  whoFor: {
    ...
    intro:
      'TotalAuthority is best suited to established practices that have credible surveyors, strong client service and the capacity to convert increased visibility into instructions.',
    typesHeading: 'Best-fit practice types',
    types: [
      'Established residential surveying practices',
      'Regional multi-office firms',
      'Boutique building consultancies',
      'Commercial surveying practices',
      'Party wall specialists',
      'Valuation-led practices',
      'Expert witness practices',
      'Dilapidations and lease advisory firms',
      'Defect and structural specialists',
      'Conservation surveying practices',
      'Project monitoring specialists',
      'Practices entering new regions',
    ],
    qualification:
      'We build authority around real expertise. The practice must be able to support its positioning through appropriate RICS qualifications, credible casework and responsible client communication.',
  },

  gaps: {
    heading: 'Why chartered surveyors lose AI visibility',
    items: [
      {
      ...
      {
        t: 'Surveyor expertise is hidden',
        b: 'Highly qualified surveyors are presented through short team biographies with little external recognition.',
      },
      {
      ...
      },
      {
        ...
        b: 'Service pages repeat the same information found on hundreds of other surveying websites.',
      },
      {
        t: 'Local and brand information conflicts',
        b: 'Practice, surveyor and office details are inconsistent across profiles and third-party sources.',
      },
      {
  ...
  proof: {
    ...
    cards: [
      ...
      },
      {
        ...
        b: 'Tier-one editorial coverage, dofollow media links, surveyor quotes, broadcast opportunities, podcast placements and journalist relationships.',
        icon: 'Megaphone',
      },
      {
      ...
      },
      {
        ...
        b: 'Quotes that reference quality of publications, strategic insight, communication, brand authority, measurable growth and surveyor positioning.',
        icon: 'Award',
      },
    ],
  },
  ...
  comparison: {
    heading: 'What makes this different from traditional surveying practice marketing?',
    ...
    authority: [
      ...
      'Build the authority of the practice and its surveyors',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'No, but the two are connected. SEO focuses heavily on website rankings and organic traffic. AI visibility also includes third-party mentions, citations, surveyor entities, reviews, external profiles, editorial coverage and the sources used to produce generated answers. Strong authority building can support both.',
      },
      {
        q: 'Does our practice still need local SEO?',
        a: 'Yes. Clients still use Google Search and Google Maps, while AI platforms may also rely on local business information. TotalAuthority complements local SEO by developing broader brand, surveyor, media and third-party authority.',
      },
      {
        q: 'Why is earned media part of the strategy?',
        a: 'Editorial coverage gives your practice independent recognition. It can connect your surveyors with relevant expertise, create authoritative mentions, earn backlinks and give both clients and AI systems additional sources through which to validate the brand.',
      },
      {
        q: 'Do you work on our website?',
        a: 'Website alignment can form part of the implementation plan. This may include positioning, service associations, surveyor information, citable content, entity clarity, structured data and internal site recommendations. The work is directed by the gaps identified in the audit and Blueprint.',
      },
      {
      ...
      {
        q: 'Can you promote individual surveyors and partners?',
        a: 'Yes, provided their experience and credentials support the positioning. Surveyor authority can include media commentary, expert biographies, service specialisation, professional profiles and expert-led content.',
      },
      {
        q: 'Can you help a multi-office practice?',
        a: 'Yes. Multi-office practices need clear connections between the parent brand, each office, surveyors, service offerings, local profiles and external mentions. The audit and strategy can be structured around individual markets or the wider practice.',
      },
      {
