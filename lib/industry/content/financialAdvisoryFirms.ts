...
export const financialAdvisoryFirms: IndustryContent = {
  slug: 'financial-advisory-firms',

  meta: {
    title: 'AI Visibility & Authority Building for Financial Advisory Firms | TotalAuthority',
    description:
  ...
  cta: {
    ...
    auditSection: 'Audit My Financial Advisory Firm',
    auditOffer: 'Get My Financial Advisory Firm Audit',
    final: 'Get Your Financial Advisory Firm AI Visibility Audit',
    mobile: 'Audit My Financial Advisory Firm',
  },
  ...
  hero: {
    ...
    dashboardTitle: 'Financial Advice AI Visibility Audit',
  },
  ...
  dashboard: {
    ...
    models: [
      { name: 'ChatGPT', score: 43, m: '5/10', c: '6/10' },
    ...
    competitors: [
      { name: 'Oakvale Wealth Advice', count: 7 },
      { name: 'Merebrook Financial', count: 5 },
  ...
  audit: {
    ...
    introPre: 'Our ',
    introPost:
      " tests the commercially valuable questions your clients are likely to ask. We don't simply search for your firm name. We test the service, life-stage and local discovery prompts that could lead to a new appointment.",
    outputCards: [
      {
  ...
  competitorIntel: {
    ...
    identifies: [
      ...
      'Competitors associated with particular life stages',
  ...
  gaps: {
    heading: 'Why financial advisory firms lose AI visibility',
    items: [
      {
      ...
      },
      {
        ...
        b: 'Service pages repeat the same information found on hundreds of other financial advice websites.',
      },
      {
  ...
  auditOffer: {
    heading: 'Get your Financial Advisory Firm AI Visibility Audit',
    intro:
