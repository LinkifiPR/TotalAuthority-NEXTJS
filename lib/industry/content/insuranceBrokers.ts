...
export const insuranceBrokers: IndustryContent = {
  slug: 'insurance-brokers',

  meta: {
    title: 'AI Visibility & Authority Building for Insurance Brokers | TotalAuthority',
    description:
      'See whether ChatGPT, Gemini and Perplexity recommend your firm when prospective clients ask who to use for business insurance. TotalAuthority audits your AI visibility and builds the earned media, content and authority signals that influence those answers.',
    keywords: [
      'AI visibility for insurance brokers',
      'insurance broker marketing',
      'commercial insurance SEO',
      'insurance authority building',
      'ChatGPT insurance broker recommendations',
  ...
  cta: {
    ...
    auditSection: 'Audit My Insurance Brokerage',
    auditOffer: 'Get My Insurance Brokerage Audit',
    final: 'Get Your Insurance Brokerage AI Visibility Audit',
    mobile: 'Audit My Insurance Brokerage',
  },

  hero: {
    eyebrow: 'AI Visibility and Authority Building for Insurance Brokers',
    ...
    dashboardTitle: 'Insurance Broker AI Visibility Audit',
  },
  ...
  dashboard: {
    ...
    models: [
      { name: 'ChatGPT', score: 41, m: '4/10', c: '5/10' },
      { name: 'Gemini', score: 46, m: '5/10', c: '3/10' },
      { name: 'Perplexity', score: 29, m: '3/10', c: '1/10' },
    ],
    competitorsHeading: 'Top competitors recommended instead',
    competitorsCaption: '4 of 10 prompts',
    competitors: [
      { name: 'Ashworth Risk Solutions', count: 7 },
      { name: 'Pennant Commercial Brokers', count: 5 },
  ...
  audit: {
    ...
    outputCards: [
      ...
      },
      {
        ...
        b: 'A simple view showing the products and searches where your firm is mentioned, not mentioned, recommended or cited.',
      },
    ],
    promptCategories: [
  ...
  competitorIntel: {
    ...
    tableRows: [
      { name: 'Ashworth Risk Solutions', m: 3, p: 7, f: '21×' },
      { name: 'Pennant Commercial Brokers', m: 2, p: 5, f: '13×' },
      { name: 'Caldwell & Hart Insurance', m: 3, p: 4, f: '10×' },
      { name: 'Redway Risk Partners', m: 1, p: 3, f: '6×' },
      { name: 'Thornbury & Lowe', m: 2, p: 2, f: '5×' },
    ],
    note:
    ...
    pillars: [
      {
        ...
        body: 'High-intent prompts tested across ChatGPT, Gemini and Perplexity. We measure mentions, citations, recommendations, positioning, product visibility, local visibility, competitors and sources.',
        icon: 'Search',
      },
      {
        num: '02',
      ...
      },
      {
        ...
        body: 'We position your qualified brokers as expert sources for journalists covering insurance, risk, commercial property and business — for editorial features, expert commentary and authoritative backlinks.',
        icon: 'Megaphone',
      },
      {
        num: '04',
        title: 'Third-Party Authority Development',
        body: 'We strengthen your presence across broker directories, review platforms, broker profiles, local business resources, insurance comparison pages and professional associations.',
        icon: 'Layers',
      },
      {
        num: '05',
        title: 'Brand and Entity Alignment',
        body: 'We align firm names, locations, broker biographies, credentials, product categories, social profiles, directory listings and website schema so AI systems build a clearer understanding of the firm.',
        icon: 'UserCheck',
      },
      {
        num: '06',
        title: 'Citable Content and Authority Assets',
        body: 'Original research, product guides, broker-led explainers, market updates, comparison pages, client decision tools and proprietary data — each asset has a defined role in the authority strategy.',
        icon: 'FileText',
      },
      {
        num: '07',
        title: 'Ongoing AI Visibility Tracking',
        body: 'We continue testing the prompts most valuable to your firm: recommendation frequency, brand mentions, product visibility, competitor share of voice, citation sources and positioning accuracy.',
        icon: 'BarChart3',
      },
      {
        num: '08',
        title: 'Local and Multi-Office Authority',
        body: 'For firms operating across one or more offices, we strengthen the local signals AI relies on: office-specific profiles, regional press, community references, structured local data and office-level broker recognition.',
        icon: 'Building2',
      },
      {
        num: '09',
  ...
  practitioner: {
    sectionLabel: 'Broker Authority',
    heading: 'Clients trust brokers, not faceless firm pages',
    paragraphs: [
    ...
    steps: [
      {
        ...
        b: 'We identify the products, locations and client searches most valuable to your firm. This prevents the campaign from becoming a broad exercise with no commercial focus.',
      },
      {
        n: '02',
      ...
      },
      {
        ...
        b: 'We improve the clarity and consistency of brand positioning, broker entities, product associations, profiles, website information, citations, structured data and local signals.',
      },
      {
        n: '05',
  ...
  gaps: {
    heading: 'Why insurance brokers lose AI visibility',
    items: [
      {
      ...
      {
        t: 'Broker expertise is hidden',
        b: 'Highly qualified brokers are presented through short team biographies with little external recognition.',
      },
      {
      ...
      },
      {
        ...
        b: 'Product pages repeat the same information found on hundreds of other insurance broker websites.',
      },
      {
        t: 'Local and brand information conflicts',
        b: 'Firm, broker and office details are inconsistent across profiles and third-party sources.',
      },
      {
  ...
  auditOffer: {
    heading: 'Get your Insurance Brokerage AI Visibility Audit',
    intro:
  ...
  proof: {
    ...
    cards: [
      ...
      },
      {
        ...
        b: 'Tier-one editorial coverage, dofollow media links, broker quotes, broadcast opportunities, podcast placements and journalist relationships.',
        icon: 'Megaphone',
      },
      {
      ...
      },
      {
        ...
        b: 'Quotes that reference quality of publications, strategic insight, communication, brand authority, measurable growth and broker positioning.',
        icon: 'Award',
      },
    ],
  },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'We create a defined set of high-intent prompts based on your products, location and commercial priorities. We then audit the answers across ChatGPT, Gemini and Perplexity, recording brand mentions, website citations, direct recommendations, competitors and source usage.',
      },
      {
      ...
      },
      {
        ...
        a: 'No, but the two are connected. SEO focuses heavily on website rankings and organic traffic. AI visibility also includes third-party mentions, citations, broker entities, reviews, external profiles, editorial coverage and the sources used to produce generated answers. Strong authority building can support both.',
      },
      {
        q: 'Does our firm still need local SEO?',
        a: 'Yes. Clients still use Google Search and Google Maps, while AI platforms may also rely on local business information. TotalAuthority complements local SEO by developing broader brand, broker, media and third-party authority.',
      },
      {
        q: 'Why is earned media part of the strategy?',
        a: 'Editorial coverage gives your firm independent recognition. It can connect your brokers with relevant expertise, create authoritative mentions, earn backlinks and give both clients and AI systems additional sources through which to validate the brand.',
      },
      {
        q: 'Do you work on our website?',
        a: 'Website alignment can form part of the implementation plan. This may include positioning, product associations, broker information, citable content, entity clarity, structured data and internal site recommendations. The work is directed by the gaps identified in the audit and Blueprint.',
      },
      {
      ...
      },
      {
        ...
        a: 'Yes. Multi-office firms need clear connections between the parent brand, each office, brokers, product offerings, local profiles and external mentions. The audit and strategy can be structured around individual markets or the wider firm.',
      },
      {
