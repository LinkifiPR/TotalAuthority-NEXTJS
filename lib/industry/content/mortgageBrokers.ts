...
export const mortgageBrokers: IndustryContent = {
  slug: 'mortgage-brokers',

  meta: {
    title: 'AI Visibility & Authority Building for Mortgage Brokers | TotalAuthority',
    description:
      'See whether ChatGPT, Gemini and Perplexity recommend your firm when prospective clients ask who to use for a mortgage. TotalAuthority audits your AI visibility and builds the earned media, content and authority signals that influence those answers.',
    keywords: [
  ...
  cta: {
    ...
    auditSection: 'Audit My Mortgage Brokerage',
    auditOffer: 'Get My Mortgage Brokerage Audit',
    final: 'Get Your Mortgage Brokerage AI Visibility Audit',
    mobile: 'Audit My Mortgage Brokerage',
  },
  ...
  hero: {
    ...
    dashboardTitle: 'Mortgage Broker AI Visibility Audit',
  },
  ...
  dashboard: {
    ...
    models: [
      ...
      { name: 'Gemini', score: 47, m: '5/10', c: '3/10' },
      { name: 'Perplexity', score: 28, m: '3/10', c: '1/10' },
    ],
  ...
  competitorIntel: {
    ...
    identifies: [
      ...
      'Firms repeatedly recommended for priority mortgage products',
  ...
  gaps: {
    heading: 'Why mortgage brokers lose AI visibility',
    items: [
      {
      ...
      },
      {
        ...
        b: 'Product pages repeat the same information found on hundreds of other mortgage broker websites.',
      },
      {
  ...
  auditOffer: {
    heading: 'Get your Mortgage Brokerage AI Visibility Audit',
    intro:
    ...
    formFields: [
      ...
      'Most important mortgage products',
