...
export const insolvencyPractitioners: IndustryContent = {
  slug: 'insolvency-practitioners',

  meta: {
    title: 'AI Visibility & Authority Building for Business Bankruptcy & Restructuring Firms | TotalAuthority',
    description:
      'See whether ChatGPT, Gemini and Perplexity recommend your firm when business owners ask who can help with Chapter 7 liquidation, Chapter 11 reorganization or business restructuring. TotalAuthority audits your AI visibility and builds the earned media, content and authority signals that influence those answers.',
    keywords: [
      'AI visibility for bankruptcy and restructuring firms',
      'bankruptcy firm marketing',
      'business restructuring SEO',
      'restructuring authority building',
      'ChatGPT bankruptcy attorney recommendations',
      'AI search for restructuring advisors',
      'digital PR for bankruptcy firms',
      'bankruptcy directory rankings',
      'ABI visibility',
      'AI visibility audit',
    ],
    ogTitle: 'AI Visibility & Authority Building for Business Bankruptcy & Restructuring Firms',
    ogDescription:
      'Find out whether AI platforms recommend your firm or your competitors, and build the authority needed to appear in the answers business owners now trust.',
  },

  cta: {
    heroPrimary: 'Get Your AI Visibility Audit',
    auditSection: 'Audit My Firm',
    auditOffer: 'Get My Firm Audit',
    final: 'Get Your Firm AI Visibility Audit',
  ...
  hero: {
    ...
    headlinePost: '',
    paragraphs: [
      'Business owners are asking ChatGPT, Gemini and Perplexity who to hire for Chapter 7 business liquidation, Chapter 11 reorganization, business restructuring, a plan of reorganization or a solvent company dissolution.',
    ...
    dashboardTitle: 'Bankruptcy & Restructuring AI Visibility Audit',
  },

  dashboard: {
    score: 46,
    scoreCaption: '14/30 audited answers mentioned the firm',
    citedLine: '8 answers',
    ...
    competitors: [
      { name: 'Ashford Recovery', count: 7 },
      { name: 'Redmond Restructuring', count: 5 },
      { name: 'Pendleton Bankruptcy', count: 4 },
    ],
    sources: [
  ...
  shift: {
    ...
    intro:
      'Business owners are increasingly using AI platforms to shortlist firms, compare options and decide which advisors appear credible. They are asking questions such as:',
    questions: [
      'Who is the best bankruptcy attorney near me?',
      'Which firm should I use to file Chapter 7 for my company?',
      'Where can I find a specialist business restructuring advisor?',
      'Which firm has the strongest reviews for Chapter 11 reorganization?',
      'Who is a trusted advisor for a solvent company dissolution?',
      'Which firm specializes in Chapter 11 plans of reorganization?',
    ],
    paragraphs: [
      'AI can answer those questions without sending the user through a traditional list of search results. Your firm may have an excellent record, experienced advisors and years of successful cases behind it. That does not guarantee you will be included.',
  ...
  audit: {
    ...
    introPre: 'Our ',
    introPost:
      " tests the commercially valuable questions business owners are likely to ask. We don't simply search for your firm name. We test the service, procedure and local discovery prompts that could lead to a new engagement.",
    outputCards: [
      {
    ...
    promptCategories: [
      'Best bankruptcy attorney in your city',
      'Best firm to file Chapter 7 for a company',
      'Best Chapter 11 reorganization specialist',
      'Best business restructuring advisor',
      'Best plan of reorganization advisor',
      'Best solvent company dissolution advisor',
      'Best turnaround and restructuring firm',
      'Best advisor for fiduciary duties of officers',
      'Best IRS / tax-debt negotiation advisor',
      'Best involuntary bankruptcy defense firm',
      'Best firm for natural-language bankruptcy queries',
      'Top-rated bankruptcy attorneys near me',
    ],
  },
  ...
  competitorIntel: {
    ...
    identifies: [
      ...
      'Competitors associated with particular procedures',
    ...
    tableRows: [
      { name: 'Ashford Recovery', m: 3, p: 7, f: '23×' },
      { name: 'Redmond Restructuring', m: 2, p: 5, f: '14×' },
      { name: 'Pendleton Bankruptcy', m: 3, p: 4, f: '11×' },
      { name: 'Coldstream Business Recovery', m: 1, p: 3, f: '6×' },
      { name: 'Hartwell & Price', m: 2, p: 2, f: '5×' },
    ],
    note:
  ...
  sourceLandscape: {
    ...
    paragraphs: [
      'Improving AI visibility is not only a website project. AI platforms may rely on bankruptcy and restructuring directories, trade press, court filings and statutory sources, professional associations, local recommendation pages, review platforms, listicles, Reddit discussions, attorney profiles, service comparison pages, competitor websites, social profiles and your own service and location pages.',
    ...
    topSources: [
      { name: 'American Bankruptcy Institute', pct: 87 },
      { name: 'PACER', pct: 71 },
      { name: 'U.S. Trustee Program', pct: 60 },
      { name: 'Avvo', pct: 35 },
    ],
    ...
    multiModel: [
      ...
      { name: 'Avvo', models: ['ChatGPT', 'Perplexity'] },
  ...
  brand: {
    ...
    positioning: [
      'Leading firm for Chapter 7 liquidation and closure',
      'Trusted advisor on business restructuring and recovery',
      'Specialist firm for Chapter 11 reorganization',
      'Recognized authority on plans of reorganization',
      'Premier advisor on solvent dissolutions and 363 sales',
      'Independently respected turnaround and restructuring team',
      'Multi-office firm with experienced bankruptcy attorneys',
    ],
  ...
  whatWeDo: {
    ...
    pillars: [
      ...
      },
      {
        ...
        body: 'We position your bankruptcy attorneys and restructuring advisors as expert sources for journalists covering business recovery, the economy, corporate distress, restructuring and small business finance — for editorial features, expert commentary and authoritative backlinks.',
        icon: 'Megaphone',
      },
      {
        num: '04',
        title: 'Third-Party Authority Development',
        body: 'We strengthen your presence across bankruptcy and restructuring directories, review platforms, attorney profiles, local business resources, service comparison pages and professional associations.',
        icon: 'Layers',
      },
      {
        num: '05',
        title: 'Brand and Entity Alignment',
        body: 'We align firm names, locations, attorney biographies, credentials, service categories, social profiles, directory listings and website schema so AI systems build a clearer understanding of the firm.',
        icon: 'UserCheck',
      },
      {
        num: '06',
        title: 'Citable Content and Authority Assets',
        body: 'Original research, procedure guides, attorney-led explainers, regulatory updates, comparison pages, business owner decision tools and proprietary data — each asset has a defined role in the authority strategy.',
        icon: 'FileText',
      },
      {
        num: '07',
      ...
      },
      {
        ...
        body: 'We strengthen the consistency and depth of the review platforms and directories AI weighs most heavily for firms — Google, Avvo, the American Bankruptcy Institute and the Turnaround Management Association — so sentiment, volume and recency reinforce recommendations.',
        icon: 'Star',
      },
    ],
  },
  ...
  earnedMedia: {
    ...
    effects: [
      ...
      'Business owners see evidence that the expert is trusted by journalists',
    ],
    closing:
  ...
  practitioner: {
    sectionLabel: 'Restructuring Authority',
    heading: 'Business owners trust attorneys, not faceless firm pages',
    paragraphs: [
      'In bankruptcy and restructuring work, the attorney handling the case can be as important as the firm itself. Your partners, bankruptcy attorneys, case managers and specialist restructuring advisors hold expertise that can strengthen the authority of the entire brand.',
    ...
    closing:
      'An attorney with genuine expertise can become a recognized source for both business owners and journalists. That authority then supports the firm they represent.',
  },

  services: {
    sectionLabel: 'Service Visibility',
    heading: 'Build visibility around the services that generate engagements',
    intro:
    ...
    focusHeading: 'A bankruptcy and restructuring strategy may focus on',
    badge: '24 services',
    items: [
      'Chapter 7 business liquidation',
      'Solvent company dissolution',
      ...
      'Fiduciary duties of officers advice',
      'Section 363 sale',
      'Out-of-court restructuring advice',
      'Cash flow and turnaround',
      ...
      'Newco / asset purchase advice',
      'Regulatory compliance',
      'Winding down a solvent company',
      'Financial distress reviews',
    ],
    closing:
    ...
    steps: [
      {
        ...
        b: 'We identify the services, procedures and client searches most valuable to your firm. This prevents the campaign from becoming a broad exercise with no commercial focus.',
      },
      {
        n: '02',
      ...
      },
      {
        ...
        b: 'We improve the clarity and consistency of brand positioning, attorney entities, service associations, profiles, website information, citations, structured data and local signals.',
      },
      {
        n: '05',
  ...
  whoFor: {
    ...
    intro:
      'TotalAuthority is best suited to established firms that have experienced bankruptcy attorneys, strong client service and the capacity to convert increased visibility into engagements.',
    typesHeading: 'Best-fit firm types',
    types: [
      'Established bankruptcy and restructuring firms',
      'Business recovery and restructuring firms',
      'Boutique turnaround specialists',
      'Corporate bankruptcy practices',
      'Consumer bankruptcy specialists',
      'Multi-office firms',
      'Regional accounting-linked practices',
      'Solvent dissolution specialists',
      'Business owner advisory firms',
      'Sector-focused recovery practices',
      'Independent bankruptcy attorneys',
      'Firms entering new regions',
    ],
    qualification:
      'We build authority around real expertise. The firm must be able to support its positioning through appropriate licensing, credible casework and responsible client communication.',
  },

  gaps: {
    heading: 'Why bankruptcy and restructuring firms lose AI visibility',
    items: [
      {
        t: 'Strong reputation, weak external evidence',
        b: 'The firm may have loyal referral sources but very few independent sources confirming its expertise.',
      },
      {
        t: 'Attorney expertise is hidden',
        b: 'Highly qualified bankruptcy attorneys are presented through short team biographies with little external recognition.',
      },
      {
      ...
      },
      {
        ...
        b: 'Service pages repeat the same information found on hundreds of other bankruptcy and restructuring websites.',
      },
      {
      ...
      },
      {
        ...
        b: 'The firm wins work through professional referral sources but has little searchable, independent authority elsewhere.',
      },
      {
  ...
  auditOffer: {
    heading: 'Get your Firm AI Visibility Audit',
    intro:
  ...
  comparison: {
    heading: 'What makes this different from traditional bankruptcy and restructuring marketing?',
    traditionalLabel: 'Old marketing playbook',
    traditional: [
      'Run paid ads for immediate inquiries',
      'Publish generic bankruptcy blogs',
  ...
  faq: {
    intro:
      'Twelve of the questions we hear most often from bankruptcy and restructuring firms considering an AI visibility program.',
    items: [
      {
        q: 'What is AI visibility for a bankruptcy and restructuring firm?',
        a: 'AI visibility refers to whether your firm appears when business owners ask platforms such as ChatGPT, Gemini and Perplexity for recommendations, comparisons or information about bankruptcy and restructuring services in your area. It also includes whether your website is cited, whether your firm is accurately described, and whether your attorneys are recognized for relevant expertise.',
      },
      {
      ...
      },
      {
        ...
        a: 'Yes. Business owners still use Google Search and Google Maps, while AI platforms may also rely on local business information. TotalAuthority complements local SEO by developing broader brand, attorney, media and third-party authority.',
      },
      {
        q: 'Why is earned media part of the strategy?',
        a: 'Editorial coverage gives your firm independent recognition. It can connect your attorneys with relevant expertise, create authoritative mentions, earn backlinks and give both business owners and AI systems additional sources through which to validate the brand.',
      },
      {
        q: 'Do you work on our website?',
        a: 'Website alignment can form part of the implementation plan. This may include positioning, service associations, attorney information, citable content, entity clarity, structured data and internal site recommendations. The work is directed by the gaps identified in the audit and Blueprint.',
      },
      {
        q: 'Do you create content?',
        a: 'Yes, where content has a clear authority purpose. This can include expert resources, original research, procedure guides, comparison pages, reports and other assets that may support citations, media outreach and business owner education.',
      },
      {
      ...
      },
      {
        ...
        a: 'Yes. Multi-office firms need clear connections between the parent brand, each office, attorneys, service offerings, local profiles and external mentions. The audit and strategy can be structured around individual markets or the wider firm.',
      },
      {
  ...
  finalCta: {
    ...
    paragraph:
      'Your firm may already be visible for some services and absent for others. The only way to know is to test the questions business owners are asking, examine the competitors appearing instead, and identify the sources influencing those answers. Start with a clear visibility baseline. Then build the authority required to compete.',
    footnote:
