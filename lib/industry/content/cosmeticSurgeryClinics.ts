...
export const cosmeticSurgeryClinics: IndustryContent = {
  slug: 'cosmetic-surgery-clinics',

  meta: {
    title: 'AI Visibility & Authority Building for Cosmetic Surgery Clinics | TotalAuthority',
    description:
      'See whether ChatGPT, Gemini and Perplexity recommend your clinic when prospective patients ask for cosmetic surgery. TotalAuthority audits your AI visibility and builds the earned media, content and authority signals that influence those answers.',
    keywords: [
      'AI visibility for cosmetic surgery clinics',
      'cosmetic surgery marketing',
      'plastic surgery SEO',
      'cosmetic surgeon authority building',
      'ChatGPT cosmetic surgery recommendations',
    ...
    ogDescription:
      'Find out whether AI platforms recommend your clinic or your competitors, and build the authority needed to appear in the answers prospective patients now trust.',
  },

  cta: {
    heroPrimary: 'Get Your AI Visibility Audit',
    auditSection: 'Audit My Cosmetic Surgery Clinic',
    auditOffer: 'Get My Cosmetic Surgery Clinic Audit',
    final: 'Get Your Cosmetic Surgery Clinic AI Visibility Audit',
    mobile: 'Audit My Cosmetic Surgery Clinic',
  },
  ...
  hero: {
    ...
    headlinePost: '',
    paragraphs: [
      'Your prospective patients are asking ChatGPT, Gemini and Perplexity who to trust for rhinoplasty, breast augmentation, liposuction, facelifts and body contouring.',
    ...
    dashboardTitle: 'Cosmetic Surgery AI Visibility Audit',
  },
  ...
  audit: {
    ...
    introPre: 'Our ',
    introPost:
      " tests the commercially valuable questions your patients are likely to ask. We don't simply search for your clinic name. We test the procedure, surgeon and local discovery prompts that could lead to a new consultation.",
    outputCards: [
      {
      ...
      },
      {
        ...
        b: 'A simple view showing the procedures and searches where your clinic is mentioned, not mentioned, recommended or cited.',
      },
    ],
    promptCategories: [
      'Best cosmetic surgery clinic in your city',
      'Best rhinoplasty surgeon',
      'Best breast augmentation clinic',
  ...
  competitorIntel: {
    ...
    intro:
      'A missing recommendation is only part of the picture. The more useful question is which competitors appear instead, how frequently they are recommended, and why AI associates them more strongly with a procedure or location.',
    identifiesHeading: 'Our audit identifies',
    identifies: [
      'Competitors appearing across multiple AI models',
      'Clinics repeatedly recommended for priority procedures',
      'Competitors associated with particular surgeons',
  ...
  sourceLandscape: {
    ...
    paragraphs: [
      'Improving AI visibility is not only a website project. AI platforms may rely on cosmetic surgery directories, accrediting bodies, lifestyle press, local recommendation pages, review platforms, listicles, Reddit discussions, surgeon profiles, procedure comparison pages, competitor websites, social profiles and your own procedure and location pages.',
  ...
  brand: {
    ...
    intro:
      'Being mentioned is not enough if your clinic is associated with the wrong procedures or described too generically. We compare what you want AI to understand with what the platforms currently say about your clinic.',
    positioningHeading: 'Positioning examples',
    positioning: [
      'Leading clinic for rhinoplasty and facial surgery',
    ...
    assess: [
      ...
      'Which procedures you are best placed to perform',
    ...
    pillars: [
      {
        ...
        body: 'High-intent prompts tested across ChatGPT, Gemini and Perplexity. We measure mentions, citations, recommendations, positioning, procedure visibility, local visibility, competitors and sources.',
        icon: 'Search',
      },
      {
        num: '02',
      ...
      },
      {
        ...
        body: 'We position your accredited surgeons as expert sources for journalists covering health, beauty, aesthetics, lifestyle and consumer affairs — for editorial features, expert commentary and authoritative backlinks.',
        icon: 'Megaphone',
      },
      {
        num: '04',
        title: 'Third-Party Authority Development',
        body: 'We strengthen your presence across cosmetic surgery directories, review platforms, surgeon profiles, local lifestyle resources, procedure comparison pages and professional associations.',
        icon: 'Layers',
      },
      {
        num: '05',
        title: 'Brand and Entity Alignment',
        body: 'We align clinic names, locations, surgeon biographies, accreditations, procedure categories, social profiles, directory listings and website schema so AI systems build a clearer understanding of the clinic.',
        icon: 'UserCheck',
      },
      {
        num: '06',
        title: 'Citable Content and Authority Assets',
        body: 'Original research, procedure guides, surgeon-led explainers, recovery updates, comparison pages, patient decision tools and proprietary data — each asset has a defined role in the authority strategy.',
        icon: 'FileText',
      },
      {
        num: '07',
        title: 'Ongoing AI Visibility Tracking',
        body: 'We continue testing the prompts most valuable to your clinic: recommendation frequency, brand mentions, procedure visibility, competitor share of voice, citation sources and positioning accuracy.',
        icon: 'BarChart3',
      },
      {
        num: '08',
        title: 'Local and Multi-Site Authority',
        body: 'For clinics operating across one or more sites, we strengthen the local signals AI relies on: site-specific profiles, regional press, community references, structured local data and site-level surgeon recognition.',
        icon: 'Building2',
      },
      {
        num: '09',
  ...
  earnedMedia: {
    ...
    closing:
      'The same piece of editorial coverage can support brand discovery, SEO, surgeon authority, patient confidence and AI visibility. This is why earned media forms a central part of the TotalAuthority process.',
  ...
  services: {
    sectionLabel: 'Procedure Visibility',
    heading: 'Build visibility around the procedures that generate consultations',
    intro:
      'Your campaign should not chase vague visibility. It should strengthen the association between your clinic, location, surgeons and the procedures you want to grow.',
    focusHeading: 'A cosmetic surgery strategy may focus on',
    badge: '24 procedures',
    items: [
      'Rhinoplasty',
      'Breast augmentation',
    ...
    closing:
      'A clinic may be highly visible for one procedure and completely absent for another. Our process exposes those differences. Every procedure is reviewed separately because the competitors, sources and authority signals can differ considerably.',
  },
    ...
    steps: [
      {
        ...
        b: 'We identify the procedures, locations and patient searches most valuable to your clinic. This prevents the campaign from becoming a broad exercise with no commercial focus.',
      },
      {
        n: '02',
      ...
      },
      {
        ...
        b: 'We improve the clarity and consistency of brand positioning, surgeon entities, procedure associations, profiles, website information, citations, structured data and local signals.',
      },
      {
        n: '05',
  ...
  beforeAfter: {
    ...
    after: [
      ...
      'Priority procedures have stronger brand association',
      'Brand descriptions become more accurate',
      'Surgeon expertise is clearer',
  ...
  whoFor: {
    ...
    intro:
      'TotalAuthority is best suited to established clinics that have accredited surgeons, strong patient care and the capacity to convert increased visibility into consultations.',
    ...
    types: [
      ...
      'Revision surgery practices',
      'Surgeon-founded clinics',
      'Hospital-affiliated practices',
      'Multi-surgeon clinics',
      'Clinics entering new regions',
    ],
    qualification:
      'We build authority around real expertise. The clinic must be able to support its positioning through appropriate accreditations, credible surgical outcomes and responsible patient communication.',
  },

  gaps: {
    heading: 'Why cosmetic surgery clinics lose AI visibility',
    items: [
      {
        t: 'Strong reputation, weak external evidence',
        b: 'The clinic may have excellent patient results but very few independent sources confirming its expertise.',
      },
      {
        t: 'Surgeon expertise is hidden',
        b: 'Highly accredited surgeons are presented through short team biographies with little external recognition.',
      },
      {
      ...
      },
      {
        ...
        b: 'Procedure pages repeat the same information found on hundreds of other cosmetic surgery websites.',
      },
      {
        t: 'Local and brand information conflicts',
        b: 'Clinic, surgeon and site details are inconsistent across profiles and third-party sources.',
      },
      {
  ...
  auditOffer: {
    heading: 'Get your Cosmetic Surgery Clinic AI Visibility Audit',
    intro:
      'See how your clinic currently appears across ChatGPT, Gemini and Perplexity. Your audit will examine high-intent prompts linked to your location, procedures and desired positioning.',
    ...
    requestIntro:
      'Your audit is reviewed using your actual brand, market, procedures and local competitors.',
    formFields: [
  ...
  proof: {
    ...
    cards: [
      ...
      },
      {
        ...
        b: 'Tier-one editorial coverage, dofollow media links, surgeon quotes, broadcast opportunities, podcast placements and journalist relationships.',
        icon: 'Megaphone',
      },
      {
      ...
      },
      {
        ...
        b: 'Quotes that reference quality of publications, strategic insight, communication, brand authority, measurable growth and surgeon positioning.',
        icon: 'Award',
      },
    ],
  },
  ...
  comparison: {
    ...
    authority: [
      ...
      'Build the authority of the clinic and its surgeons',
      'Build connected media, brand, entity and citation signals',
      'Measure procedure visibility, competitor share and source influence',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'We create a defined set of high-intent prompts based on your procedures, location and commercial priorities. We then audit the answers across ChatGPT, Gemini and Perplexity, recording brand mentions, website citations, direct recommendations, competitors and source usage.',
      },
      {
      ...
      },
      {
        ...
        a: 'No, but the two are connected. SEO focuses heavily on website rankings and organic traffic. AI visibility also includes third-party mentions, citations, surgeon entities, reviews, external profiles, editorial coverage and the sources used to produce generated answers. Strong authority building can support both.',
      },
      {
        q: 'Does our clinic still need local SEO?',
        a: 'Yes. Patients still use Google Search and Google Maps, while AI platforms may also rely on local business information. TotalAuthority complements local SEO by developing broader brand, surgeon, media and third-party authority.',
      },
      {
        q: 'Why is earned media part of the strategy?',
        a: 'Editorial coverage gives your clinic independent recognition. It can connect your surgeons with relevant expertise, create authoritative mentions, earn backlinks and give both patients and AI systems additional sources through which to validate the brand.',
      },
      {
        q: 'Do you work on our website?',
        a: 'Website alignment can form part of the implementation plan. This may include positioning, procedure associations, surgeon information, citable content, entity clarity, structured data and internal site recommendations. The work is directed by the gaps identified in the audit and Blueprint.',
      },
      {
      ...
      },
      {
        ...
        a: 'Yes. Multi-site clinics need clear connections between the parent brand, each site, surgeons, procedure offerings, local profiles and external mentions. The audit and strategy can be structured around individual markets or the wider clinic.',
      },
      {
  ...
  related: {
    ...
    intro:
      'Explore how TotalAuthority approaches visibility and authority building for other healthcare and aesthetic providers.',
  },
  ...
  finalCta: {
    ...
    paragraph:
      'Your clinic may already be visible for some procedures and absent for others. The only way to know is to test the questions your prospective patients are asking, examine the competitors appearing instead, and identify the sources influencing those answers. Start with a clear visibility baseline. Then build the authority required to compete.',
    footnote:
      'Measured across ChatGPT, Gemini and Perplexity using prompts tailored to your clinic, procedures and location.',
  },
};
