...
export const investmentFirms: IndustryContent = {
  slug: 'investment-firms',

  meta: {
    title: 'AI Visibility & Authority Building for Investment Firms | TotalAuthority',
    description:
      'See whether ChatGPT, Gemini and Perplexity recommend your firm when prospective investors ask who to use for managing their money. TotalAuthority audits your AI visibility and builds the earned media, content and authority signals that influence those answers.',
    keywords: [
      'AI visibility for investment firms',
      'investment firm marketing',
      'wealth management SEO',
      'investment authority building',
      'ChatGPT investment firm recommendations',
    ...
    ogDescription:
      'Find out whether AI platforms recommend your firm or your competitors, and build the authority needed to appear in the answers prospective investors now trust.',
  },

  cta: {
    heroPrimary: 'Get Your AI Visibility Audit',
    auditSection: 'Audit My Investment Firm',
    auditOffer: 'Get My Investment Firm Audit',
    final: 'Get Your Investment Firm AI Visibility Audit',
    mobile: 'Audit My Investment Firm',
  },
  ...
  hero: {
    ...
    dashboardTitle: 'Investment Firm AI Visibility Audit',
  },

  dashboard: {
    score: 52,
    scoreCaption: '16/30 audited answers mentioned the firm',
    citedLine: '9 answers',
    citedSub: 'cited the website',
    models: [
      { name: 'ChatGPT', score: 44, m: '5/10', c: '6/10' },
      { name: 'Gemini', score: 49, m: '5/10', c: '3/10' },
      { name: 'Perplexity', score: 31, m: '3/10', c: '1/10' },
    ],
    competitorsHeading: 'Top competitors recommended instead',
    competitorsCaption: '4 of 10 prompts',
    competitors: [
      { name: 'Marchmont Capital', count: 7 },
      { name: 'Eldon Asset Management', count: 5 },
  ...
  shift: {
    heading: 'Your next investor may ask AI before they search Google',
    intro:
  ...
  audit: {
    ...
    introPre: 'Our ',
    introPost:
      " tests the commercially valuable questions your investors are likely to ask. We don't simply search for your firm name. We test the service, strategy and local discovery prompts that could lead to a new mandate.",
    outputCards: [
      {
    ...
    promptCategories: [
      ...
      'Best firm for tax-efficient investing',
      'Best manager for high-net-worth investors',
      'Best firm for model portfolio services',
      'Best manager for alternative investments',
      'Best firm for natural-language investment queries',
      'Top-rated investment firms near me',
    ],
  },
  ...
  competitorIntel: {
    ...
    identifies: [
      ...
      'Firms repeatedly recommended for priority investment services',
      'Competitors associated with particular strategies',
    ...
    tableRows: [
      { name: 'Marchmont Capital', m: 3, p: 7, f: '24×' },
      { name: 'Eldon Asset Management', m: 2, p: 5, f: '14×' },
      { name: 'Ravenshill Investments', m: 3, p: 4, f: '11×' },
      { name: 'Holborne Wealth Partners', m: 1, p: 3, f: '6×' },
      { name: 'Carrington & Blythe', m: 2, p: 2, f: '5×' },
    ],
    note:
  ...
  sourceLandscape: {
    ...
    paragraphs: [
      'Improving AI visibility is not only a website project. AI platforms may rely on fund research platforms, financial press, comparison sites, investor forums, review platforms, listicles, Reddit discussions, manager profiles, strategy comparison pages, competitor websites, social profiles and your own service and location pages.',
  ...
  brand: {
    ...
    assess: [
      ...
      'Which mandates you are best placed to handle',
  ...
  whatWeDo: {
    ...
    pillars: [
      ...
      },
      {
        ...
        body: 'We position your qualified managers as expert sources for journalists covering investing, markets, personal finance and the economy — for editorial features, expert commentary and authoritative backlinks.',
        icon: 'Megaphone',
      },
      {
        num: '04',
        title: 'Third-Party Authority Development',
        body: 'We strengthen your presence across fund research platforms, review platforms, manager profiles, local business resources, strategy comparison pages and professional associations.',
        icon: 'Layers',
      },
      {
        num: '05',
        title: 'Brand and Entity Alignment',
        body: 'We align firm names, locations, manager biographies, credentials, service categories, social profiles, directory listings and website schema so AI systems build a clearer understanding of the firm.',
        icon: 'UserCheck',
      },
      {
        num: '06',
        title: 'Citable Content and Authority Assets',
        body: 'Original research, strategy guides, manager-led explainers, market updates, comparison pages, investor decision tools and proprietary data — each asset has a defined role in the authority strategy.',
        icon: 'FileText',
      },
      {
        num: '07',
      ...
      },
      {
        ...
        body: 'For firms operating across one or more offices, we strengthen the local signals AI relies on: office-specific profiles, regional press, community references, structured local data and office-level manager recognition.',
        icon: 'Building2',
      },
      {
        num: '09',
  ...
  earnedMedia: {
    ...
    effects: [
      ...
      'Investors see evidence that the expert is trusted by journalists',
    ],
    closing:
      'The same piece of editorial coverage can support brand discovery, SEO, manager authority, investor confidence and AI visibility. This is why earned media forms a central part of the TotalAuthority process.',
    logosHeading: 'Publications featuring our clients and their experts',
  },

  practitioner: {
    sectionLabel: 'Manager Authority',
    heading: 'Investors trust managers, not faceless firm pages',
    paragraphs: [
      'In investment management, the manager running the strategy can be as important as the firm itself. Your chief investment officer, fund managers, analysts and portfolio specialists hold expertise that can strengthen the authority of the entire brand.',
  ...
  services: {
    ...
    heading: 'Build visibility around the services that generate assets',
    intro:
      'Your campaign should not chase vague visibility. It should strengthen the association between your firm, location, managers and the services you want to grow.',
    ...
    steps: [
      {
        ...
        b: 'We identify the services, locations and investor searches most valuable to your firm. This prevents the campaign from becoming a broad exercise with no commercial focus.',
      },
      {
        n: '02',
      ...
      },
      {
        ...
        b: 'We improve the clarity and consistency of brand positioning, manager entities, service associations, profiles, website information, citations, structured data and local signals.',
      },
      {
        n: '05',
  ...
  beforeAfter: {
    ...
    before: [
      ...
      'Managers have little external authority',
  ...
  whoFor: {
    ...
    intro:
      'TotalAuthority is best suited to established firms that have credible managers, strong investor service and the capacity to convert increased visibility into new mandates.',
    typesHeading: 'Best-fit firm types',
    types: [
      'Established discretionary managers',
      'Regional wealth management firms',
      'Boutique investment houses',
      'Multi-office practices',
      'Specialist ESG investment firms',
      'Multi-asset and model portfolio providers',
      'Private equity and venture firms',
      'Income and capital growth specialists',
      'High-net-worth bespoke mandate firms',
      'Tax-efficient investment specialists',
      'Trust and charity investment teams',
      'Firms entering new regions',
    ],
    qualification:
      'We build authority around real expertise. The firm must be able to support its positioning through appropriate qualifications, credible track record and responsible investor communication.',
  },

  gaps: {
    heading: 'Why investment firms lose AI visibility',
    items: [
      {
        t: 'Strong reputation, weak external evidence',
        b: 'The firm may have loyal investors but very few independent sources confirming its expertise.',
      },
      {
        t: 'Manager expertise is hidden',
        b: 'Highly qualified managers are presented through short team biographies with little external recognition.',
      },
      {
      ...
      },
      {
        ...
        b: 'Service pages repeat the same information found on hundreds of other investment firm websites.',
      },
      {
        t: 'Local and brand information conflicts',
        b: 'Firm, manager and office details are inconsistent across profiles and third-party sources.',
      },
      {
        t: 'Marketing is focused entirely on referrals',
        b: 'The firm wins mandates through introducers and word of mouth but has little searchable, independent authority elsewhere.',
      },
      {
  ...
  auditOffer: {
    heading: 'Get your Investment Firm AI Visibility Audit',
    intro:
    ...
    formFields: [
      ...
      'Most important investment services',
  ...
  proof: {
    ...
    cards: [
      ...
      },
      {
        ...
        b: 'Tier-one editorial coverage, dofollow media links, manager quotes, broadcast opportunities, podcast placements and journalist relationships.',
        icon: 'Megaphone',
      },
      {
      ...
      },
      {
        ...
        b: 'Quotes that reference quality of publications, strategic insight, communication, brand authority, measurable growth and manager positioning.',
        icon: 'Award',
      },
    ],
  },
  ...
  comparison: {
    ...
    authority: [
      ...
      'Build the authority of the firm and its managers',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'No, but the two are connected. SEO focuses heavily on website rankings and organic traffic. AI visibility also includes third-party mentions, citations, manager entities, reviews, external profiles, editorial coverage and the sources used to produce generated answers. Strong authority building can support both.',
      },
      {
        q: 'Does our firm still need local SEO?',
        a: 'Yes. Investors still use Google Search and Google Maps, while AI platforms may also rely on local business information. TotalAuthority complements local SEO by developing broader brand, manager, media and third-party authority.',
      },
      {
        q: 'Why is earned media part of the strategy?',
        a: 'Editorial coverage gives your firm independent recognition. It can connect your managers with relevant expertise, create authoritative mentions, earn backlinks and give both investors and AI systems additional sources through which to validate the brand.',
      },
      {
        q: 'Do you work on our website?',
        a: 'Website alignment can form part of the implementation plan. This may include positioning, service associations, manager information, citable content, entity clarity, structured data and internal site recommendations. The work is directed by the gaps identified in the audit and Blueprint.',
      },
      {
        q: 'Do you create content?',
        a: 'Yes, where content has a clear authority purpose. This can include expert resources, original research, strategy guides, comparison pages, reports and other assets that may support citations, media outreach and investor education.',
      },
      {
      ...
      },
      {
        ...
        a: 'Yes. Multi-office firms need clear connections between the parent brand, each office, managers, service offerings, local profiles and external mentions. The audit and strategy can be structured around individual markets or the wider firm.',
      },
      {
  ...
  related: {
    heading: 'AI visibility for adjacent financial services',
    intro:
      'Explore how TotalAuthority approaches visibility and authority building for other financial services and advisory firms.',
  },
  ...
  finalCta: {
    ...
    paragraph:
      'Your firm may already be visible for some services and absent for others. The only way to know is to test the questions your prospective investors are asking, examine the competitors appearing instead, and identify the sources influencing those answers. Start with a clear visibility baseline. Then build the authority required to compete.',
    footnote:
