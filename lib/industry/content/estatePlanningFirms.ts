...
export const estatePlanningFirms: IndustryContent = {
  ...
  hero: {
    ...
    dashboardTitle: 'Estate Planning AI Visibility Audit',
  },
  ...
  dashboard: {
    ...
    competitors: [
      { name: 'Wexford Estate Planning', count: 7 },
      { name: 'Thornbury Wills & Trusts', count: 5 },
      { name: 'Ashby Legacy Partners', count: 4 },
    ],
    sources: [
      'STEP',
      'NAEPC',
  ...
  competitorIntel: {
    ...
    tableRows: [
      { name: 'Wexford Estate Planning', m: 3, p: 7, f: '23×' },
      { name: 'Thornbury Wills & Trusts', m: 2, p: 5, f: '14×' },
      { name: 'Ashby Legacy Partners', m: 3, p: 4, f: '11×' },
      { name: 'Marsden Private Client', m: 1, p: 3, f: '6×' },
      { name: 'Carrington & Hale', m: 2, p: 2, f: '5×' },
    ],
    note:
  ...
  gaps: {
    heading: 'Why estate planning firms lose AI visibility',
    items: [
      {
      ...
      },
      {
        ...
        b: 'Service pages repeat the same information found on hundreds of other estate planning websites.',
      },
      {
