...
export const eyeClinics: IndustryContent = {
  slug: 'eye-clinics',

  meta: {
    title: 'AI Visibility & Authority Building for Eye Clinics | TotalAuthority',
    description:
      'See whether ChatGPT, Gemini and Perplexity recommend your clinic when patients ask where to go for cataract surgery, laser eye treatment or glaucoma care. TotalAuthority audits your AI visibility and builds the earned media, content and authority signals that influence those answers.',
    keywords: [
      'AI visibility for eye clinics',
      'ophthalmology marketing',
      'eye clinic SEO',
      'optometry authority building',
      'ChatGPT eye clinic recommendations',
      'AI search for ophthalmologists',
      'digital PR for eye clinics',
      'laser eye surgery marketing',
      'cataract clinic visibility',
      'AI visibility audit',
    ],
    ogTitle: 'AI Visibility & Authority Building for Eye Clinics',
    ogDescription:
  ...
  hero: {
    ...
    headlinePost: '',
    paragraphs: [
      'Your prospective patients are asking ChatGPT, Gemini and Perplexity where to go for cataract surgery, laser eye treatment, lens replacement, glaucoma care and the management of conditions such as macular degeneration.',
    ...
    dashboardTitle: 'Eye Clinic AI Visibility Audit',
  },
  ...
  dashboard: {
    ...
    models: [
      { name: 'ChatGPT', score: 45, m: '4/10', c: '5/10' },
      { name: 'Gemini', score: 50, m: '5/10', c: '3/10' },
      { name: 'Perplexity', score: 35, m: '3/10', c: '2/10' },
    ],
  ...
  shift: {
    ...
    paragraphs: [
      'AI can answer those questions without sending the patient through a traditional list of search results. Your clinic may have leading surgeons, advanced equipment and years of clinical outcomes behind it. That does not guarantee you will be included.',
  ...
  audit: {
    ...
    introPre: 'Our ',
    introPost:
      " tests the commercially valuable questions your patients are likely to ask. We don't simply search for your clinic name. We test the procedure, service and local discovery prompts that could lead to a new booking.",
    outputCards: [
      {
    ...
    promptCategories: [
      'Best eye clinic in your city',
      'Best cataract surgery clinic',
      'Best laser eye surgery provider',
      'Best lens replacement clinic',
  ...
  competitorIntel: {
    ...
    tableRows: [
      ...
      { name: 'Optera Eye Hospital', m: 2, p: 2, f: '5×' },
    ],
    note:
  ...
  whatWeDo: {
    ...
    pillars: [
      ...
      },
      {
        ...
        body: 'We strengthen your presence across health directories, review platforms, surgeon profiles, consumer review sites, procedure comparison pages and professional associations.',
        icon: 'Layers',
      },
      {
        num: '05',
        title: 'Brand and Entity Alignment',
        body: 'We align clinic names, locations, surgeon biographies, credentials, procedure categories, social profiles, directory listings and website schema so AI systems build a clearer understanding of the clinic.',
        icon: 'UserCheck',
      },
      {
        num: '06',
        title: 'Citable Content and Authority Assets',
        body: 'Original research, procedure guides, surgeon-led explainers, eye health updates, comparison pages, patient decision tools and proprietary data — each asset has a defined role in the authority strategy.',
        icon: 'FileText',
      },
      {
        num: '07',
  ...
  services: {
    ...
    heading: 'Build visibility around the procedures that drive bookings',
    intro:
    ...
    focusHeading: 'An eye clinic strategy may focus on',
    badge: '24 procedures',
    items: [
      'Cataract surgery',
  ...
  whoFor: {
    ...
    intro:
      'TotalAuthority is best suited to established clinics that have credible surgeons, strong patient care and the capacity to convert increased visibility into bookings.',
    typesHeading: 'Best-fit clinic types',
    types: [
      'Private ophthalmology clinics',
      'Laser eye surgery providers',
      'Cataract and lens replacement clinics',
      ...
      'Refractive and vision correction clinics',
  ...
  gaps: {
    heading: 'Why eye clinics lose AI visibility',
    items: [
      {
      ...
      },
      {
        ...
        b: 'Procedure pages repeat the same information found on hundreds of other eye clinic websites.',
      },
      {
  ...
  auditOffer: {
    heading: 'Get your Eye Clinic AI Visibility Audit',
    intro:
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Yes. Multi-site groups need clear connections between the parent brand, each site, surgeons, procedure offerings, local profiles and external mentions. The audit and strategy can be structured around individual markets or the wider group.',
      },
      {
