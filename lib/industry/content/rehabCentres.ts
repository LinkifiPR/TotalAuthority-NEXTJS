...
export const rehabCentres: IndustryContent = {
  ...
  whatWeDo: {
    ...
    pillars: [
      ...
      },
      {
        ...
        body: 'We position your clinicians and therapists as expert sources for journalists covering addiction, recovery, mental health, public health and family wellbeing — for editorial features, expert commentary and authoritative backlinks.',
        icon: 'Megaphone',
      },
      {
        num: '04',
      ...
      },
      {
        ...
        body: 'Original research, treatment guides, clinician-led explainers, recovery updates, comparison pages, client decision tools and proprietary data — each asset has a defined role in the authority strategy.',
        icon: 'FileText',
      },
      {
        num: '07',
  ...
  earnedMedia: {
    ...
    closing:
      'The same piece of editorial coverage can support brand discovery, SEO, clinician authority, client confidence and AI visibility. This is why earned media forms a central part of the TotalAuthority process.',
  ...
  process: {
    ...
    steps: [
      ...
      },
      {
        ...
        b: 'We improve the clarity and consistency of brand positioning, clinician entities, treatment associations, profiles, website information, citations, structured data and local signals.',
      },
      {
        n: '05',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Website alignment can form part of the implementation plan. This may include positioning, treatment associations, clinician information, citable content, entity clarity, structured data and internal site recommendations. The work is directed by the gaps identified in the audit and Blueprint.',
      },
      {
        q: 'Do you create content?',
        a: 'Yes, where content has a clear authority purpose. This can include expert resources, original research, treatment guides, comparison pages, reports and other assets that may support citations, media outreach and client education.',
      },
      {
