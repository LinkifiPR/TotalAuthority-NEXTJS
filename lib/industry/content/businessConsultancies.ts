...
export const businessConsultancies: IndustryContent = {
  ...
  whatWeDo: {
    ...
    pillars: [
      ...
      },
      {
        ...
        body: 'We position your senior consultants as expert sources for journalists covering business, management, transformation, the economy and the workplace — for editorial features, expert commentary and authoritative backlinks.',
        icon: 'Megaphone',
      },
      {
        num: '04',
      ...
      },
      {
        ...
        body: 'Original research, sector guides, consultant-led explainers, market insights, comparison pages, client decision tools and proprietary data — each asset has a defined role in the authority strategy.',
        icon: 'FileText',
      },
      {
        num: '07',
  ...
  earnedMedia: {
    ...
    closing:
      'The same piece of editorial coverage can support brand discovery, SEO, consultant authority, client confidence and AI visibility. This is why earned media forms a central part of the TotalAuthority process.',
    logosHeading: 'Publications featuring our clients and their experts',
  },

  practitioner: {
    sectionLabel: 'Consultant Authority',
    heading: 'Clients trust consultants, not faceless firm pages',
    paragraphs: [
      'In consulting, the person leading the engagement can be as important as the firm itself. Your managing partners, practice leads, principals and specialist consultants hold expertise that can strengthen the authority of the entire brand.',
  ...
  process: {
    ...
    steps: [
      ...
      },
      {
        ...
        b: 'We improve the clarity and consistency of brand positioning, consultant entities, service associations, profiles, website information, citations, structured data and local signals.',
      },
      {
        n: '05',
  ...
  gaps: {
    ...
    items: [
      ...
      },
      {
        ...
        b: 'Firm, consultant and office details are inconsistent across profiles and third-party sources.',
      },
      {
  ...
  auditOffer: {
    ...
    requestIntro:
      'Your audit is reviewed using your actual brand, market, services and direct competitors.',
    formFields: [
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Website alignment can form part of the implementation plan. This may include positioning, service associations, consultant information, citable content, entity clarity, structured data and internal site recommendations. The work is directed by the gaps identified in the audit and Blueprint.',
      },
      {
