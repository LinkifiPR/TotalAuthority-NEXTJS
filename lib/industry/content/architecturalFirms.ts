...
export const architecturalFirms: IndustryContent = {
  ...
  meta: {
    ...
    keywords: [
      ...
      'architect marketing',
      'architecture practice SEO',
      'architectural authority building',
    ...
    ogTitle: 'AI Visibility & Authority Building for Architectural Firms',
    ogDescription:
  ...
  hero: {
    ...
    dashboardTitle: 'Architecture Practice AI Visibility Audit',
  },
  ...
  dashboard: {
    ...
    models: [
      { name: 'ChatGPT', score: 42, m: '4/10', c: '6/10' },
    ...
    competitors: [
      { name: 'Studio Verrow', count: 7 },
      { name: 'Calderbank Architects', count: 5 },
  ...
  audit: {
    ...
    introPre: 'Our ',
    introPost:
      " tests the commercially valuable questions your clients are likely to ask. We don't simply search for your practice name. We test the service, sector and local discovery prompts that could lead to a new commission.",
    outputCards: [
      {
  ...
  competitorIntel: {
    ...
    tableRows: [
      { name: 'Studio Verrow', m: 3, p: 7, f: '23×' },
      { name: 'Calderbank Architects', m: 2, p: 5, f: '14×' },
      { name: 'Northgate Design Studio', m: 3, p: 4, f: '11×' },
      { name: 'Halewood & Pryce', m: 1, p: 3, f: '6×' },
      { name: 'Atelier Marsden', m: 2, p: 2, f: '5×' },
    ],
    note:
  ...
  sourceLandscape: {
    ...
    paragraphs: [
      'Improving AI visibility is not only a website project. AI platforms may rely on professional bodies, design press, review platforms, local recommendation pages, listicles, Reddit discussions, architect profiles, service comparison pages, competitor websites, social profiles and your own service and location pages.',
  ...
  whatWeDo: {
    ...
    pillars: [
      ...
      },
      {
        ...
        body: 'We position your qualified architects as expert sources for journalists covering architecture, design, property, planning and sustainable building — for editorial features, expert commentary and authoritative backlinks.',
        icon: 'Megaphone',
      },
      {
        num: '04',
        title: 'Third-Party Authority Development',
        body: 'We strengthen your presence across professional bodies, design publications, review platforms, architect profiles, local business resources, service comparison pages and industry associations.',
        icon: 'Layers',
      },
      {
        num: '05',
        title: 'Brand and Entity Alignment',
        body: 'We align practice names, studio locations, architect biographies, credentials, service categories, social profiles, directory listings and website schema so AI systems build a clearer understanding of the practice.',
        icon: 'UserCheck',
      },
      {
        num: '06',
        title: 'Citable Content and Authority Assets',
        body: 'Original research, project case studies, architect-led explainers, design updates, comparison pages, client decision tools and proprietary data — each asset has a defined role in the authority strategy.',
        icon: 'FileText',
      },
      {
        num: '07',
      ...
      {
        num: '08',
        title: 'Local and Multi-Studio Authority',
        body: 'For practices operating across one or more studios, we strengthen the local signals AI relies on: studio-specific profiles, regional press, community references, structured local data and studio-level architect recognition.',
        icon: 'Building2',
      },
      {
        num: '09',
  ...
  earnedMedia: {
    ...
    closing:
      'The same piece of editorial coverage can support brand discovery, SEO, architect authority, client confidence and AI visibility. This is why earned media forms a central part of the TotalAuthority process.',
  ...
  services: {
    ...
    intro:
      'Your campaign should not chase vague visibility. It should strengthen the association between your practice, location, architects and the services you want to grow.',
    focusHeading: 'An architecture strategy may focus on',
    badge: '24 services',
    items: [
  ...
  process: {
    ...
    steps: [
      ...
      },
      {
        ...
        b: 'We improve the clarity and consistency of brand positioning, architect entities, service associations, profiles, website information, citations, structured data and local signals.',
      },
      {
        n: '05',
  ...
  beforeAfter: {
    ...
    before: [
      ...
      'Architects have little external authority',
    ...
    after: [
      ...
      'Architect expertise is clearer',
  ...
  whoFor: {
    ...
    intro:
      'TotalAuthority is best suited to established practices that have credible architects, strong client service and the capacity to convert increased visibility into commissions.',
    typesHeading: 'Best-fit practice types',
    types: [
      'Established residential practices',
    ...
    qualification:
      'We build authority around real expertise. The practice must be able to support its positioning through appropriate qualifications, credible projects and responsible client communication.',
  },

  gaps: {
    heading: 'Why architectural firms lose AI visibility',
    items: [
      {
      ...
      {
        t: 'Architect expertise is hidden',
        b: 'Highly qualified architects are presented through short team biographies with little external recognition.',
      },
      {
      ...
      },
      {
        ...
        b: 'Service pages repeat the same information found on hundreds of other architecture websites.',
      },
      {
        t: 'Local and brand information conflicts',
        b: 'Practice, architect and studio details are inconsistent across profiles and third-party sources.',
      },
      {
        t: 'Marketing is focused entirely on portfolio',
        b: 'The practice wins work through its portfolio and referrals but has little searchable, independent authority elsewhere.',
      },
      {
  ...
  auditOffer: {
    ...
    formFields: [
      ...
      'Primary location and number of studios',
  ...
  proof: {
    ...
    cards: [
      ...
      },
      {
        ...
        b: 'Tier-one editorial coverage, dofollow media links, architect quotes, broadcast opportunities, podcast placements and journalist relationships.',
        icon: 'Megaphone',
      },
      {
      ...
      },
      {
        ...
        b: 'Quotes that reference quality of publications, strategic insight, communication, brand authority, measurable growth and architect positioning.',
        icon: 'Award',
      },
    ],
  },
  ...
  comparison: {
    ...
    authority: [
      ...
      'Build the authority of the practice and its architects',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'No, but the two are connected. SEO focuses heavily on website rankings and organic traffic. AI visibility also includes third-party mentions, citations, architect entities, reviews, external profiles, editorial coverage and the sources used to produce generated answers. Strong authority building can support both.',
      },
      {
        q: 'Does our practice still need local SEO?',
        a: 'Yes. Clients still use Google Search and Google Maps, while AI platforms may also rely on local business information. TotalAuthority complements local SEO by developing broader brand, architect, media and third-party authority.',
      },
      {
        q: 'Why is earned media part of the strategy?',
        a: 'Editorial coverage gives your practice independent recognition. It can connect your architects with relevant expertise, create authoritative mentions, earn backlinks and give both clients and AI systems additional sources through which to validate the brand.',
      },
      {
        q: 'Do you work on our website?',
        a: 'Website alignment can form part of the implementation plan. This may include positioning, service associations, architect information, citable content, entity clarity, structured data and internal site recommendations. The work is directed by the gaps identified in the audit and Blueprint.',
      },
      {
      ...
      },
      {
        ...
        a: 'Yes. Multi-studio practices need clear connections between the parent brand, each studio, architects, service offerings, local profiles and external mentions. The audit and strategy can be structured around individual markets or the wider practice.',
      },
      {
