          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
              ...
              <div className="group relative overflow-hidden rounded-3xl bg-card/50 backdrop-blur-sm border border-border/50 hover:shadow-2xl transition-all duration-700 hover:-translate-y-3 animate-fade-in [animation-delay:200ms]">
                <div className="aspect-[16/10] relative overflow-hidden">
                  {/* Placeholder gradient background - original images not migrated */}
                  <div className="absolute inset-0 bg-gradient-to-br from-orange-600 via-red-500 to-orange-700 transition-all duration-700 group-hover:scale-110">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center">
                        <Mic className="w-16 h-16 text-white/30 mx-auto mb-2" />
                        <span className="text-white/40 text-sm font-medium">Link Building Mastery</span>
                      </div>
                    </div>
                  </div>
                  <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent" />
